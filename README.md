...
- [jenkinsci/docker-agent](https://github.com/jenkinsci/docker-agent) ([4.13-1](https://github.com/jenkinsci/docker-agent/releases/tag/4.13-1), 6 days ago) - Base Docker image for Jenkins Agents
- [markusfisch/BinaryEye](https://github.com/markusfisch/BinaryEye) ([1.48.1](https://github.com/markusfisch/BinaryEye/releases/tag/1.48.1), 6 days ago) - Yet another barcode scanner for Android
- [ventoy/Ventoy](https://github.com/ventoy/Ventoy) ([v1.0.71](https://github.com/ventoy/Ventoy/releases/tag/v1.0.71), 6 days ago) - A new bootable USB solution.
