...
- [vlang/v](https://github.com/vlang/v) ([weekly.2022.07](https://github.com/vlang/v/releases/tag/weekly.2022.07), today) - Simple, fast, safe, compiled language for developing maintainable software. Compiles itself in &lt;1s with zero library dependencies. https://vlang.io
- [ventoy/Ventoy](https://github.com/ventoy/Ventoy) ([v1.0.67](https://github.com/ventoy/Ventoy/releases/tag/v1.0.67), today) - A new bootable USB solution.
