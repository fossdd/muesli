...
- [UPC/ravada](https://github.com/UPC/ravada) ([v1.0.5](https://github.com/UPC/ravada/releases/tag/v1.0.5), 5 days ago) - Remote Virtual Desktops Manager
- [vlang/v](https://github.com/vlang/v) ([weekly.2021.37](https://github.com/vlang/v/releases/tag/weekly.2021.37), 1 week ago) - Simple, fast, safe, compiled language for developing maintainable software. Compiles itself in &lt;1s with zero library dependencies. https://vlang.io
...
- [cli/cli](https://github.com/cli/cli) ([v2.0.0](https://github.com/cli/cli/releases/tag/v2.0.0), 4 weeks ago) - GitHub’s official command line tool
