...
- [vlang/v](https://github.com/vlang/v) ([weekly.2021.42.1](https://github.com/vlang/v/releases/tag/weekly.2021.42.1), 1 day ago) - Simple, fast, safe, compiled language for developing maintainable software. Compiles itself in &lt;1s with zero library dependencies. https://vlang.io
- [ventoy/Ventoy](https://github.com/ventoy/Ventoy) ([v1.0.55](https://github.com/ventoy/Ventoy/releases/tag/v1.0.55), 4 days ago) - A new bootable USB solution.
- [jenkinsci/docker-agent](https://github.com/jenkinsci/docker-agent) ([4.11-1](https://github.com/jenkinsci/docker-agent/releases/tag/4.11-1), 5 days ago) - Base Docker image for Jenkins Agents
