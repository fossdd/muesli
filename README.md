...
- [helix-editor/helix](https://github.com/helix-editor/helix) ([v0.6.0](https://github.com/helix-editor/helix/releases/tag/v0.6.0), 1 day ago) - A post-modern modal text editor.
- [jenkinsci/docker-agent](https://github.com/jenkinsci/docker-agent) ([4.11.2-4](https://github.com/jenkinsci/docker-agent/releases/tag/4.11.2-4), 2 days ago) - Base Docker image for Jenkins Agents
