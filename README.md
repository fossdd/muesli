...
- [theel0ja/foss-android](https://github.com/theel0ja/foss-android) - List of free and open-source alternatives to proprietary Android apps. (4 weeks ago)
...
- [UPC/ravada](https://github.com/UPC/ravada) ([v1.3.4](https://github.com/UPC/ravada/releases/tag/v1.3.4), 3 days ago) - Remote Virtual Desktops Manager
- [ventoy/Ventoy](https://github.com/ventoy/Ventoy) ([v1.0.70](https://github.com/ventoy/Ventoy/releases/tag/v1.0.70), 6 days ago) - A new bootable USB solution.
- [cli/cli](https://github.com/cli/cli) ([v2.5.1](https://github.com/cli/cli/releases/tag/v2.5.1), 1 week ago) - GitHub’s official command line tool
- [vlang/v](https://github.com/vlang/v) ([weekly.2022.07](https://github.com/vlang/v/releases/tag/weekly.2022.07), 1 week ago) - Simple, fast, safe, compiled language for developing maintainable software. Compiles itself in &lt;1s with zero library dependencies. https://vlang.io
