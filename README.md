...
- [massivemadness/Squircle-IDE](https://github.com/massivemadness/Squircle-IDE) ([2.1.0](https://github.com/massivemadness/Squircle-IDE/releases/tag/2.1.0), 1 day ago) - 👨‍💻 Squircle IDE is a fast and free multi-language code editor for Android
...
- [vlang/v](https://github.com/vlang/v) ([weekly.2021.44](https://github.com/vlang/v/releases/tag/weekly.2021.44), 2 days ago) - Simple, fast, safe, compiled language for developing maintainable software. Compiles itself in &lt;1s with zero library dependencies. https://vlang.io
- [ventoy/Ventoy](https://github.com/ventoy/Ventoy) ([v1.0.57](https://github.com/ventoy/Ventoy/releases/tag/v1.0.57), 6 days ago) - A new bootable USB solution.
