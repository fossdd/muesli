...
- [vlang/v](https://github.com/vlang/v) ([0.2.4](https://github.com/vlang/v/releases/tag/0.2.4), 2 days ago) - Simple, fast, safe, compiled language for developing maintainable software. Compiles itself in &lt;1s with zero library dependencies. https://vlang.io
- [ventoy/Ventoy](https://github.com/ventoy/Ventoy) ([v1.0.51](https://github.com/ventoy/Ventoy/releases/tag/v1.0.51), 5 days ago) - A new bootable USB solution.
- [jenkinsci/docker-agent](https://github.com/jenkinsci/docker-agent) ([4.10-2](https://github.com/jenkinsci/docker-agent/releases/tag/4.10-2), 6 days ago) - Base Docker image for Jenkins Agents
