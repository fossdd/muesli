...
- [jenkinsci/docker-agent](https://github.com/jenkinsci/docker-agent) ([4.10-3](https://github.com/jenkinsci/docker-agent/releases/tag/4.10-3), 1 day ago) - Base Docker image for Jenkins Agents
- [vlang/v](https://github.com/vlang/v) ([0.2.4](https://github.com/vlang/v/releases/tag/0.2.4), 4 days ago) - Simple, fast, safe, compiled language for developing maintainable software. Compiles itself in &lt;1s with zero library dependencies. https://vlang.io
