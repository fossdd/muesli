...
- [ventoy/Ventoy](https://github.com/ventoy/Ventoy) ([v1.0.64](https://github.com/ventoy/Ventoy/releases/tag/v1.0.64), 1 day ago) - A new bootable USB solution.
- [vlang/v](https://github.com/vlang/v) ([weekly.2022.01](https://github.com/vlang/v/releases/tag/weekly.2022.01), 2 days ago) - Simple, fast, safe, compiled language for developing maintainable software. Compiles itself in &lt;1s with zero library dependencies. https://vlang.io
- [cli/cli](https://github.com/cli/cli) ([v2.5.0-pre5](https://github.com/cli/cli/releases/tag/v2.5.0-pre5), 2 days ago) - GitHub’s official command line tool
- [helix-editor/helix](https://github.com/helix-editor/helix) ([v0.6.0](https://github.com/helix-editor/helix/releases/tag/v0.6.0), 5 days ago) - A post-modern modal text editor.
- [jenkinsci/docker-agent](https://github.com/jenkinsci/docker-agent) ([4.11.2-4](https://github.com/jenkinsci/docker-agent/releases/tag/4.11.2-4), 6 days ago) - Base Docker image for Jenkins Agents
